      ...
      <div className="pt-20 w-full max-w-[1240px] max-md:pt-12">
        <div className="flex flex-wrap justify-between gap-10 max-md:flex-col max-md:items-center">
          ...
          <div className="flex flex-col gap-5 flex-1 min-w-[280px] max-w-full max-md:items-center max-md:text-center">
            <div className="py-3 pr-4 pl-6 rounded border-l-2 border-[#0F1535] bg-[#DDE2FF] w-fit max-w-[250px]">
            ...
            <div className="mt-5 text-base leading-[27.2px] w-full max-w-[590px] text-slate-950">
              <p>
                What started as a solution for the tourism industry has grown
                into a powerful platform that connects people to places ���
                virtually. Whether it's a winery tour, a Petty Zoo memory, or a
                walk around an 1880 town, we let users see, record, and relive
                experiences from wherever they are.
              </p>
              <p className="text-neutral-600 mt-4">
                "This platform was born from personal stories — and built to
